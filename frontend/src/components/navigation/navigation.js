        ...
        <>
            <div className='nav-title playfair p-2'>
                <div className='ml-2 mt-auto mb-auto'>
                    {isAuthenticated&&location.pathname.includes('/admin') ? <Button style={{float:'right', margin: '12px 2px'}} size='sm' variant='dark' className='oswald' onClick={() => logout()}>LOG OUT</Button> : (<>  <span style={{ float: "right", marginRight: '2%', lineHeight: 1.3, cursor: 'pointer' }} onClick={() => history.push('/cart')}>
                        ...
                        <i class="fa fa-user-circle " onClick={() => history.push('/admin')} style={{ fontSize: '21px', float: "right", marginRight: '2%', cursor: 'pointer' }}></i>
